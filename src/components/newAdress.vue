...
<template>
<div class="ProvCityBoxWarp"  @touchmove.prevent>
...
<script>
import {province, city, area} from '../config/city-data'
...
export default {
    ...
    mounted: function() {
        // this.$ajax({//请求后台地址
        //     url: '/wct/ysp/json/threeaddress',
        //     method: 'post'
        // }).then(res => {
        //     if (res.data.code == 1) {
        //         // const province = res.data.data.province;
    ...
    methods: {
        ...
        initData(){
            ...
            this.provinceState.selectedId = 440000; //北京市  省
            this.provinceState.translateY = -630;
            this.provinceState.index = 18;
            this.cityState.selectedId = 440100;     //市辖区  市
            this.areaState.selectedId = 440103;     //东城区  区
            // this.filterProvince();
            this.filterCity();
            this.filterArea();
            // this.submit();
